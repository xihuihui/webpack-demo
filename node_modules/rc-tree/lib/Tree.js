  ...
  function Tree() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = Tree.__proto__ || Object.getPrototypeOf(Tree)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      promise.then(function () {
        ...
        _this.setState({
          loadingKeys: (0, _util.arrDel)(_this.state.loadingKeys, eventKey)
        });
      ...
      var _this$state4 = _this.state,
          ...
          expandedKeys = _this$state4$expanded === undefined ? [] : _this$state4$expanded,
          _this$state4$selected = _this$state4.selectedKeys,
          selectedKeys = _this$state4$selected === undefined ? [] : _this$state4$selected,
          _this$state4$halfChec = _this$state4.halfCheckedKeys,
          halfCheckedKeys = _this$state4$halfChec === undefined ? [] : _this$state4$halfChec,
          _this$state4$loadedKe = _this$state4.loadedKeys,
          loadedKeys = _this$state4$loadedKe === undefined ? [] : _this$state4$loadedKe,
          _this$state4$loadingK = _this$state4.loadingKeys,
          loadingKeys = _this$state4$loadingK === undefined ? [] : _this$state4$loadingK,
  ...
  (0, _createClass3['default'])(Tree, [{
    ...
    value: function getDerivedStateFromProps(props, prevState) {
      ...
      if (treeNode) {
        ...
        var entitiesMap = (0, _util.convertTreeToEntities)(treeNode, props.unstable_processTreeEntity);
...
Tree.propTypes = {
  ...
  unstable_processTreeEntity: _propTypes2['default'].shape({
    initWrapper: _propTypes2['default'].func.isRequired,
    processEntity: _propTypes2['default'].func.isRequired,
    onProcessFinished: _propTypes2['default'].func.isRequired
  })
};
